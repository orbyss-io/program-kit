...
Version 2 binds Foundation 0.2.2 with Forms 0.2.0. Version 1 remains historical;
the product contracts and released-reference identity are unchanged.
...
powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\scripts\Start-IntakeSession.ps1 -KeepWorkspace `
  -IdeaFile tests\live\scenarios\knowledge-application\v2\PROJECT_REQUEST.md `
  -AcceptanceContracts tests\live\scenarios\knowledge-application\v2\bootstrap-seed\fixture\acceptance
```
