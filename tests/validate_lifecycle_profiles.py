...
def validate_openapi_initialization() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="program-kit-openapi-init-") as value:
        ...
        manifest.write_text(
            json.dumps({
                "tools": {"programkit.openapi.exporter": {"version": "0.8.11-preview.1"}}
            }),
            encoding="utf-8",
        )
        ...
        if (
            contract["producer"]["version"] != "0.8.11-preview.1"
...
def validate_artifact_ownership() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="program-kit-external-host-") as value:
        ...
        contract = {
            ...
            "documentName": "v1",
            "shell": "default",
            "producer": {"kind": "ProgramKit.OpenApi.Exporter", "version": "0.8.11-preview.1"},
