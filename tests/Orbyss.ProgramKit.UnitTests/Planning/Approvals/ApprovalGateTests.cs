...
namespace Orbyss.ProgramKit.UnitTests.Planning.Approvals;
...
public sealed class ApprovalGateTests
{
    ...
    public void ExactUnconditionalActiveHumanApprovalHasAValidRelationship()
    {
        ...
        ImplementationPlanDocumentValidator planValidator =
            new ImplementationPlanDocumentValidator(envelopeValidator);
        DesignPlanApprovalRecordValidator approvalValidator =
            new DesignPlanApprovalRecordValidator(envelopeValidator);
        DesignPlanApprovalRelationshipValidator relationshipValidator =
            new DesignPlanApprovalRelationshipValidator(
                planValidator,
                approvalValidator);

        var validation = relationshipValidator.Validate(
            plan,
            PlanReference,
            DesignReference,
            approval);
    ...
    public void MissingChangedRejectedConditionalAndSupersededApprovalFailClosed()
    {
        ...
        Assert.IsFalse(relationshipValidator.Validate(
            plan,
            PlanReference,
            DesignReference,
            null).IsValid);
    ...
    public void EveryDeclaredRequirementRequiresItsOwnTraceDisposition()
    {
        ...
        var validation = planValidator.Validate(incomplete);
    ...
    public void ApprovalCannotSupersedeItselfByExactDigestReference()
    {
        ...
        var validation = approvalValidator.Validate(envelope);
    ...
    public void UnknownPlanningEnumsFailClosed()
    {
        ...
        var planValidation = planValidator.Validate(plan);
        var approvalValidation = approvalValidator.Validate(approval);
    ...
    public void PlanRejectsWrongMigrationTestAndProfileKinds()
    {
        ...
        var validation = planValidator.Validate(invalid);
