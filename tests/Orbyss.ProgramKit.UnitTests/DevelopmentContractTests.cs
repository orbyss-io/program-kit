...
public sealed class DevelopmentContractTests
{
    ...
    public void RoutingSelectsZeroOrOneCapabilityFromTheExactAvailabilitySnapshot()
    {
        ...
        var validation = new DevelopmentRoutingResultValidator().ValidateAgainst(
            result,
            snapshot,
            SnapshotReference);
    ...
    public void RoutingRejectsMultipleOrUnavailableCapabilities()
    {
        ...
        var cardinality = new DevelopmentRoutingOutcomeValidator().Validate(tooMany);
        var availability = new DevelopmentRoutingResultValidator().ValidateAgainst(
            unavailableResult,
            snapshot,
            SnapshotReference);
    ...
    public void HumanDecisionAndUnavailableOutcomesCannotDelegateANextCapability()
    {
        ...
        var humanDecisionResult =
            new DevelopmentRoutingOutcomeValidator().Validate(humanDecision);
        var unavailableResult =
            new DevelopmentRoutingOutcomeValidator().Validate(unavailable);
    ...
    public void RoutingContractsContainNoAuthorityGrant()
    {
        ...
        Assert.IsFalse(
            routingProperties.Concat(resultProperties).Any(property =>
    ...
    public void ReceiptIsEvidenceBoundToExactInputsAndAnExplicitTimeBoundary()
    {
        ...
        Assert.IsFalse(typeof(DevelopmentReceipt).GetProperties().Any(property =>
    ...
    public void EnvelopedRoutingRejectsAnExactReferenceToItsOwnRevision()
    {
        ...
        var validation = new DevelopmentRoutingResultValidator().Validate(envelope);
    ...
    public void UnknownDevelopmentEnumsFailClosed()
    {
        ...
        var snapshotValidation =
            new CapabilityAvailabilitySnapshotValidator().Validate(snapshot);
        var receiptValidation = new DevelopmentReceiptValidator().Validate(receipt);
