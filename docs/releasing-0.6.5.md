# Releasing Program Kit 0.6.5

This patch removes design-file naming assumptions and redundant post-install narration from both
consumer initializers and the active bootstrap guidance.
...
Verify that `VERSION` is `0.6.5`, `RUNTIME_VERSION` remains `0.6.0-preview.1`, all component
manifests and catalogs agree, and `artifacts/SHA256SUMS` covers these release assets:

- `program-kit-0.6.5.zip`
- `program-kit-governance-0.6.5.zip`
- `program-kit-dotnet-0.6.5.zip`
- `program-kit-governance-preset-0.6.5.zip`
- `program-kit-bootstrap-0.6.5.zip`
- `Initialize-ProgramKit-0.6.5.cmd`
- `Initialize-ProgramKit-0.6.5.sh`

The runtime NuGet packages and host image remain at `0.6.0-preview.1`; this patch changes bootstrap
distribution and guidance behavior only.
