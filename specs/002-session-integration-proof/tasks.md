...
- [ ] T106 CRITICAL Establish one versioned canonical session-integration definition artifact, load and validate its complete governed contract through `SessionIntegrationDefinitionLoader`, replace placeholder fingerprints with exact content identities, and add round-trip, drift, and projection-binding tests per FR-007, FR-012, FR-013, Constitution III, and Constitution IV (partial)
- [ ] T107 CRITICAL Make the embedded Codex provider manifest the single validated runtime source for provider, adapter, definition, conformance, surface, tested-version, diagnostic, support, and projection identities; reject placeholder or divergent identities and prove manifest/runtime equality per FR-012 through FR-014 and FR-034 through FR-036 (partial)
- [ ] T108 CRITICAL Verify the selected CLI release before candidate admission by resolving the exact workspace-local executable and checking the CLI identity schema/profile, package identity and digest evidence, command, executable digest, reported version, and runtime profile against observed evidence; add unavailable and mismatch fixtures for every field per FR-002, FR-018, FR-020, SC-007, US1/AC1, and the executable-mismatch edge case (partial)
- [ ] T109 CRITICAL Invoke the declared provider conformance profile during production resolution and admission, and fail closed on support, scope, operation, ownership, definition, diagnostic, projection, disclosure, authority, or normalization loss instead of relying on test-only conformance per FR-014, FR-018, FR-020, FR-038, US4/AC2, and Constitution VI (partial)
- [ ] T110 CRITICAL Harden installation inspection and verification to validate the record schema and digest, admission/publication evidence, and exact binding to the current CLI, canonical definition, provider, adapter, conformance profile, workspace, and projection set; classify corrupt, stale, incompatible, partial, idempotent, reload-required, and fresh-session states without mutation per FR-013 and FR-020 through FR-023, SC-002, SC-007, and US1/AC1–AC4 (partial)
- [ ] T111 Complete the packaged-CLI negative matrix for malformed, ambiguous, unsupported, unavailable CLI/executable, missing or incompatible provider, collision, interruption, stale state, drift, and missing authority; assert distinct diagnostic identities, dispositions, effect states, and byte preservation per FR-039 through FR-043, SC-004, and US3/AC1–AC4 (partial)
