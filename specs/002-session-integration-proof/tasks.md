...
- [ ] T118 Execute a new explicitly authorized ten-consecutive-fresh-session review against the exact CI-green packet and record a separate bounded evidence document; do not overwrite or reinterpret the rejected 8/10 run (missing) | Refs: FR-024 through FR-032, SC-003, SC-005, product-review condition 3 | Proof: human-operated `eng/Invoke-CodexSessionReview.ps1` with exactly 10 trials | Tier: human | Done: a fresh evidence document truthfully reports all ten trial attestations and its status is `review-ready` only at 10/10
- [ ] T119 Obtain a new independent human product-review decision over the exact CI and fresh-session evidence, recording reviewer identity, decision, limitations, invalidation set, and timestamp without treating automation or agent judgment as approval (missing) | Refs: SC-003, SC-005, product-review condition 4, Constitution I, Constitution IX | Proof: named independent decision in `reviews/product-review.md` | Tier: human | Done: the reviewer explicitly approves or rejects the remediated candidate and the record makes no release/publication claim
- [ ] T120 Reconcile every FR/SC and the Phase 10 ledger against the exact executable and human evidence, preserving superseded/rejected provenance and leaving Feature 002 incomplete unless all mandatory gates—including T117–T119—are satisfied (missing) | Refs: all FR-001 through FR-046, SC-001 through SC-010, Constitution IX | Proof: final requirement/evidence table plus follow-up `$speckit-analyze` with no unresolved CRITICAL/HIGH finding | Tier: human | Done: the final disposition is truthful, all completed tasks cite current proof, and product acceptance is claimed only if the independent decision approves it
