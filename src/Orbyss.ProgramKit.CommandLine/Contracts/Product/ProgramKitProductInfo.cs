namespace Orbyss.ProgramKit.CommandLine.Contracts.Product;

/// <summary>Single product identity projected into the CLI consumer contract.</summary>
public static class ProgramKitProductInfo
{
    ...
    /// <summary>Gets the exact capability knowledge-closure format.</summary>
    public const string CapabilityKnowledgeFormatVersion = "0.1.0-alpha.1";
}
