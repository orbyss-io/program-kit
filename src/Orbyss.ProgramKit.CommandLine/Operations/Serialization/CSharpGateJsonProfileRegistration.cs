    ...
    public void Register(IProgramKitJsonBuilder builder)
    {
        ...
        builder.AddOwnedProfile(
            ...
            new JsonProfileOwnedMechanics(
                ...
                Model<CSharpGateRuleCatalog>(),
                Model<CSharpGateActivationMatrix>(),
                Model<CSharpGateSuppressionLedger>(),
                Model<ConsumerAnalyzerScaffoldRequest>(),
                Model<CSharpGateBindRequest>(),
                Model<CSharpGateBindRequestAlpha1>(),
                Model<CSharpGateLockIntent>(),
                Model<CSharpGateLockInputProjection>(),
                Model<CSharpGateSelectionLockOutputProjection>(),
                Model<CSharpBuildGateSelectionLockDocument>(),
                Model<CSharpBuildGateSelectionLockDocumentAlpha1>(),
                ...
                Enum<CSharpGateLockInventoryKind>(),
