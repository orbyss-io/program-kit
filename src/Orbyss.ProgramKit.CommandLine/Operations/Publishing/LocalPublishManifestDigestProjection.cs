...
/// <summary>Exact local-publish manifest shape used to calculate its non-self-referential digest.</summary>
internal sealed record LocalPublishManifestDigestProjection(
    ...
    LocalPublishIntegrityProjection Integrity);
