...
7. For an effect-bearing request, ask the human to select or provide the exact existing request-bound grant required by the typed result; stop when that exact authority is absent or invalid.
