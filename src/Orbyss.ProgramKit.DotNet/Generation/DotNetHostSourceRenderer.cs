...
public sealed class DotNetHostSourceRenderer : IDotNetHostSourceRenderer
{
        ...
        OpenApiDocumentProjection? openApiDocument)
    {
        ...
        outputs.Add(new GeneratedOutput(
            ...
            DotNetSourceText.Utf8(RenderIntegrityRequirement())));
        outputs.Add(new GeneratedOutput(
        ...
        DotNetHostLock hostLock)
    {
        ...
        builder.AppendLine("    <PackageReference Include=\"Orbyss.ProgramKit.GeneratedOutputIntegrity.Build\" Version=\"[0.1.0-alpha.3]\" PrivateAssets=\"all\" />");
        builder.AppendLine("  </ItemGroup>");
        builder.AppendLine("</Project>");
        return builder.ToString();
    }

    private static string RenderIntegrityRequirement() =>
        """
