...
public sealed class DotNetSecurityProjectionCompiler : IDotNetSecurityProjectionCompiler
{
    ...
    private static ImmutableArray<GeneratedOutput> RenderPublicBrowser(
        ...
        [
            ...
            DirectOutput(
                ...
                RenderPublicBrowserRedirectToLogin()),
            DirectOutput(
                "PublicBrowser/Shared/ProgramKitLogout.razor",
                RenderPublicBrowserLogout()),
            DirectOutput(
                ...
                <Found Context="routeData">
                    <AuthorizeRouteView RouteData="@routeData">
                        <NotAuthorized>
                            ...
                            {
                                <p role="status">Not authorized.</p>
                            }
                        </NotAuthorized>
                    </AuthorizeRouteView>
                </Found>
    ...
    private static string RenderPublicBrowserImports() =>
        ...
        @using GeneratedPublicBrowser.Shared
        """;
    ...
    private static string RenderPublicBrowserRedirectToLogin() =>
        """
        @* <auto-generated program-kit> *@
        @using Microsoft.AspNetCore.Components.WebAssembly.Authentication
    ...
    private static string RenderPublicBrowserLogout() =>
        """
        @* <auto-generated program-kit> *@
        @using Microsoft.AspNetCore.Components.WebAssembly.Authentication
        @inject NavigationManager Navigation

        <button id="program-kit-logout" type="button" @onclick="BeginLogout">
            Sign out
        </button>
        ...
        DotNetOidcConfidentialInteractiveProfile profile)
    {
        ...
        builder.AppendLine("    options.Events.OnRedirectToIdentityProviderForSignOut = context =>");
        builder.AppendLine("    {");
        builder.AppendLine("        if (string.IsNullOrEmpty(context.ProtocolMessage.IdTokenHint) &&");
        builder.AppendLine("            string.IsNullOrEmpty(context.ProtocolMessage.ClientId))");
        builder.AppendLine("        {");
        builder.AppendLine("            context.ProtocolMessage.ClientId = context.Options.ClientId;");
        builder.AppendLine("        }");
        builder.AppendLine();
