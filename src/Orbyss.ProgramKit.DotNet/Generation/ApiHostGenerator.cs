...
/// <summary>Generates one exact API host.</summary>
public sealed class ApiHostGenerator : IWorkbenchGenerator<DotNetHostGenerationInput>
{
    ...
    public ApiHostGenerator(IDotNetHostGenerationCoordinator coordinator)
    {
    ...
    public ValueTask<ImmutableArray<GeneratedOutput>> GenerateAsync(
        ...
        coordinator.GenerateAsync(input, DotNetHostKind.Api, cancellationToken);
}
