    ...
    IProgramKitSemanticValidator<ArtifactDecision>
{
    ...
    public ProgramKitValidationResult Validate(ArtifactDecision value)
    {
        ...
        if (value is null)
        {
            diagnostics.Error(ArchitectureDiagnosticIds.Pkarc300, "/", "An artifact decision is required.");
        ...
        ArchitectureDiagnosticBag diagnostics)
    {
        ...
        var ownership = SupportedArtifactKindOwnershipResolver.Resolve(decision.ArtifactKind);
