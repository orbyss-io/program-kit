...
/// </summary>
public sealed class SupportedArtifactKindOwnershipResolver :
    ISupportedArtifactKindOwnershipResolver
{
    ...
    public ImmutableArray<SupportedArtifactKindOwnership> All => Rules;
    ...
    public SupportedArtifactKindOwnership Resolve(SupportedArtifactKind artifactKind)
    {
    ...
    public bool SupportsArtifactIdentity(
    ...
    public bool SupportsOwnerIdentity(
        SupportedArtifactKind artifactKind,
        string ownerKind) =>
