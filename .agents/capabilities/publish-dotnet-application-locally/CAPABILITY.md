...
`.codex/skills/publish-dotnet-application-locally/SKILL.md` may only register
this trigger and load this exact canonical file. Verify no operation mechanics
or procedure are copied into the wrapper and that the index links to both files.
