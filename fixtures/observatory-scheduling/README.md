...
- typed shell, lock, OpenAPI, Open Console, and Open Worker generation whose
  bytes repeat deterministically, including the language-neutral Console
  grammar and its declared host exit-code roles; and
...
it is not the generated typed-Spectre process proof. That proof belongs to the
isolated Program Kit typed Console conformance fixture.
